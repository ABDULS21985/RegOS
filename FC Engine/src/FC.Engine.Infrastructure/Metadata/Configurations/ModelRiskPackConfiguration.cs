...
public sealed class ModelRiskPackSheetRecordConfiguration : IEntityTypeConfiguration<ModelRiskPackSheetRecord>
{
    public void Configure(EntityTypeBuilder<ModelRiskPackSheetRecord> builder)
    {
        builder.ToTable("model_risk_pack_sheets", "meta");
