# FC Engine — Financial Institution Portal: 20 Master Implementation Prompts
...
The FC Engine solution lives at `/Users/mac/codes/fcs/FC Engine/` and contains these projects:
...
1. **Create the project**:
   ```
   FC Engine/src/FC.Engine.Portal/
...
1. **Login Page** (`/login`):
   ...
   - "Central Bank of Nigeria — FC Engine" subtitle
...
1. **Submission Validation Report** (from Submission Detail):
   ...
   - Data preview table
   - Footer: "Generated by FC Engine — Central Bank of Nigeria"
   - Use `@media print` CSS
